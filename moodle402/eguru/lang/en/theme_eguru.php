...
<p>Authors: LMSATC Dev Team<br>
Contact: info@atcom.vn<br>
Website: <a href="https://atcom.vn">www.atcom.vn</a><br> </p>';
$string['configtitle'] = 'Eguru';
$string['connectus'] = 'Connect with us';
$string['contact'] = 'Contact';
$string['customcss'] = 'Custom CSS';
$string['customcssdesc'] = 'Whatever CSS rules you add to this textarea will be reflected in every page, making for easier customization of this theme.';
$string['defaultaddress'] = '59 Phuc Xa Str, Ba Dinh Dst, Ha Noi, Vietnam';
$string['defaultemailid'] = 'info@atcom.vn';
$string['defaultphoneno'] = '(+84) 974 599 599';
...
$string['footnotedefault'] = 'AT.COM Co., Ltd - Technology Development and Trading Business Company would like to send to our customers and partners the most respectful greetings. Established in 2006, AT.COM has quickly become a leading developer of high-quality, sustainable and accurate IT services and training consulting in Vietnam in general. Currently is the Center for Research, Consulting and Deployment of IT Infrastructures: Virtualization, HPC, HCI and Cloud Edge Computing No.1 in Vietnam.';
...
$string['footerbtitle2default'] = 'About Us';
$string['footerbtitle3default'] = 'Quicklink';
$string['footerbtitle4default'] = 'Contact';
$string['footerblink'] = 'Footer Block Link';
$string['footerblink2default'] = 'lang:aboutus|https://atcom.vn
lang:termsofuse|https://digital.cloud.edu.vn
lang:faq|https://pmi.cloud.edu.vn
lang:support|https://support.atcom.vn
lang:atcomdb|https://pbi.cloud.edu.vn/
lang:github|https://github.com/';
...
$string['promotedtitledefault'] = 'COURSES BY TOPICS';
...
$string['mspot1descdefault'] = 'Bilingual mode or you can choose: default English, or configure the system to display Vietnamese, Rusia, Korea, Japan, Italy, Germany.';
$string['mspot2titledefault'] = 'Blend Study';
$string['mspot2descdefault'] = 'AT.COM researched and implemented training programs in 4 training models:1. Training at the center, 2. Training at the Customers, 3. Online training through LMS, LCMS and Webinar, 4. Both training at the Center and Teaching Online.';
$string['mspot3titledefault'] = 'Community Support';
$string['mspot3descdefault'] = 'Teachers and Instructors always keep in touch with students through Skype group, Teams Classroom. We always advise and guarantee the quality of training forever.';
$string['mspot4titledefault'] = 'Responsive Design';
$string['mspot4descdefault'] = '1. Students can access the subjects they have registered and have paid for the course, 2. Go to Smartphone App or email it to the site: info@atcom.vn for training advice.';
...
$string['termsofuse'] = 'Digital Literacy';
$string['faq'] = 'PMI';
$string['support'] = 'Support';
$string['atcomdb'] = 'AT.COM Dataverse';
$string['github'] = 'AT.COM DevSecOps github';
$string['copyright'] = 'Copyright';
$string['copyright_default'] = '<p class="text-center">Copyright &copy; 2006 - Developed by
            <a href="https://atcom.vn">ATCOM.VN</a>.Powered by AT.COM</p>';
